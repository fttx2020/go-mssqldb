...
[![Go Reference](https://pkg.go.dev/badge/github.com/fttx2020/go-mssqldb.svg)](https://pkg.go.dev/github.com/fttx2020/go-mssqldb)
[![Build status](https://ci.appveyor.com/api/projects/status/jrln8cs62wj9i0a2?svg=true)](https://ci.appveyor.com/project/fttx2020/go-mssqldb)
[![codecov](https://codecov.io/gh/fttx2020/go-mssqldb/branch/master/graph/badge.svg)](https://codecov.io/gh/fttx2020/go-mssqldb)

## Install

Requires Go 1.8 or above.

Install with `go get github.com/fttx2020/go-mssqldb` .
 ...
 * [NewConnector](https://godoc.org/github.com/fttx2020/go-mssqldb#NewConnector)
    may be used with [OpenDB](https://golang.org/pkg/database/sql/#OpenDB).
 * [Connector.SessionInitSQL](https://godoc.org/github.com/fttx2020/go-mssqldb#Connector.SessionInitSQL)
